...
1. Draw DAG to understand the relations between variables
```{r}
# Confounding variables are age, sex, prev_avg_purch
purchase_dag <- dagify(
  card  ~ age + sex + pre_avg_purch, sex ~ age , pre_avg_purch ~ sex, avg_purch ~ card ,
  coords = list(x = c(age = 1,sex = 2, pre_avg_purch = 3, card = 2, avg_purch = 2),
                      y = c(age = 1,sex = 1, pre_avg_purch = 1, card = 3, avg_purch = 4)  )
)
